...
#         index = st.session_state["question_index"] # current index
#         new_index = (index + direction) % self.total_questions # new index
#         st.session_state["question_index"] = new_index # update index
